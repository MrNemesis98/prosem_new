...
https://github.com/smnmnkr/cltrier_prosem

The respective python files are my own extensions for data preprocessing. Furthermore I changed the folder structures for better organizing of my own data.
